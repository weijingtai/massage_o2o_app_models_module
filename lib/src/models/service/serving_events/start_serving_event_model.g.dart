...
part of 'start_serving_event_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

StartServingEventModel _$StartServingEventModelFromJson(Map json) =>
...
Map<String, dynamic> _$StartServingEventModelToJson(
        StartServingEventModel instance) =>
    <String, dynamic>{
      'guid': instance.guid,
