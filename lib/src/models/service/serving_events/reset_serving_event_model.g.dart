...
part of 'reset_serving_event_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ResetServingEventModel _$ResetServingEventModelFromJson(Map json) =>
...
Map<String, dynamic> _$ResetServingEventModelToJson(
        ResetServingEventModel instance) =>
    <String, dynamic>{
      'guid': instance.guid,
